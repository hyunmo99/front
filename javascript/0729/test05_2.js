...
const year = today.getFullYear(); //년도 처리
...
str += "오늘 요일 : " + week + "요일<br>";
str += "오늘 요일 : " + strWeek[week] + "요일<br>";

//이번달의 마지막 일자?
// let lastDate = new Date(year, month, 0); 년, 월, 일) // 년 월 받기
let lastDate = new Date(2400, 2, 0);
str += "이번달 마지막 일자는 : " + lastDate.getDate() + "요일<br>";
